...
map.getView().fit([2339647.637927, 6879495.717421, 2416995.043264, 6925071.414104], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza przebiegu rzeki Bug 1940-2024</h2>';
        return titleElement;
    })(),
